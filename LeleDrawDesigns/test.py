...
histogram = Histogram(poss_results, frequencies, x_ticks=x_labels, x_ticks_fontsize=20, y_ticks_fontsize=20,
                      skin='Solarize_Light2', title=title, title_fontsize=20, x_label=xlabel, y_label=ylabel,
                      y_label_fontsize=20, color='green', edgecolor='black', figsize=(15, 10))
