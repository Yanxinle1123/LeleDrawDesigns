...
curved_line_chart = LineChart(input_values=[1, 2, 3, 4, 5], squares=[1, 4, 9, 16, 25], style='curved',
                              line_color='green', skin='Solarize_Light2', set_title='CurvedLineChart',
                              set_title_fontsize=20,
...
straight_line_chart = LineChart(input_values=[1, 2, 3, 4, 5], squares=[1, 4, 9, 16, 25], style='straight',
                                line_color='green', skin='Solarize_Light2', set_title='StraightLineChart',
                                set_title_fontsize=20,
                                set_x_label='XLabel', set_x_label_fontsize=20, set_y_label='YLabel',
                                set_y_label_fontsize=20, line_width=3)
...
histogram = Histogram(title='Histogram', title_fontsize=20, x_label='XLabel', x_label_fontsize=20, y_label='YLabel',
                      y_label_fontsize=20, color='green', edgecolor='black')
