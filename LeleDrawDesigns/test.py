...
histogram = Histogram(poss_results, frequencies, x_ticks=x_labels, x_ticks_fontsize=20, y_ticks_fontsize=50,
                      skin='Solarize_Light2', title=title, title_fontsize=20, x_label=xlabel, y_label=ylabel,
                      x_label_fontsize=20, y_label_fontsize=20, color='green', edgecolor='black', figsize=(10, 7),
